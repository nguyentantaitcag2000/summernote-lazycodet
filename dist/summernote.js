...
var toolbar = renderer.create('<hr class="note-hr-toolbar LazyTrigger"/><div class="panel-heading note-toolbar" role="toolbar"/>');
...
var editable = renderer.create(`
    <div class="container-editor container-fluid">
        <div class="row">
            <div class="col-sm-2 left-side-note col-1 bg-secondary text-white" style="width: 50px;padding: 10px;">
                <div class="arrow-note-line" style="position:absolute"><p>→</p></div>
            </div>
            <div class="col-sm-10">
